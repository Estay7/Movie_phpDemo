...
<body>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/workV2/Homepage.php"><i class="" style="font-size: 23px;"></i>HOME</a>
            </div>
    ...
    <div class="wallpa">
        ...
        <hr/>
            ...
            ?>
        <hr/>
            <a href="/workV2/index.php" class="btn btn-primary">Enter the upload page.</a><br/>
            <br/><a href="logout.php" class="btn btn-primary">exit</a>
