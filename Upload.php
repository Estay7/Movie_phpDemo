...
<body>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Homepage.php"><i class="" style="font-size: 23px;"></i>HOME</a>
            </div>
    ...
    <div class="wallpaper2">
        ...
        if($type=='MP4'|| $type=='mp4') {
            ...
            echo "<body>";
            echo"<center><h3>Upload completed<h3></center><br><br>";
            echo "<center><a href='index.php'>Redirect in <span id=\"redirect\">5</span> Second</a></center>";
        }else {
            echo "<br/><br/>";
            echo "<center>Please upload the file as MP4 format</center>";
            echo "<br/><br/>";
